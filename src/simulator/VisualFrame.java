...
//        this.bg.drawString(this.message, 50, 50);
        ...
        for (String line : this.message.split("\n"))
            this.bg.drawString(line, 50, y += g.getFontMetrics().getHeight());
        ...
        this.bg.setColor(new Color(0.0F, 0.0F, 1.0F, 0.5F));
        this.bg.fillOval((int)target.x*2 / this.Scale - (int) targetSize + getWidth() / 2, -(int)target.y*2 / this.Scale - (int)targetSize   + getHeight() / 2, (int)targetSize  * 2, (int) targetSize  * 2);
