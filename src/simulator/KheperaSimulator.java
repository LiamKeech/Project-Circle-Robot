...
public class KheperaSimulator
{
    ...
    public static final int lineRadius = 2;
    public static final double arcRadius = 25;
...
//    Integer QuadSize = 10;
    ...
    public KheperaSimulator(State start) {
        ...
        startState = start;
        srs = new SensorReadingSimulator(sensorAngle, obstacleDangerDistance, robotRadius, obstacleRadius, lineRadius); 
...
//    public void populateQuads(ArrayList<Code.Point> obstacles)
//    {
//        Integer x;
//        Integer y;
//        Boolean busy = true;
...
//            for(Code.Point obstacle : obstacles)
//            {
...
//            ks.underSensors = srs.getLineReading((int) startState.sx, (int) startState.sy, startState.sa, linePoints);
            ks.collision = false;
            this.kstates.add(ks);
        }
        ...
        {            
            ...
            KheperaState ks = new KheperaState();
            ks.position = s;
            //ArrayList<Code.Point> obstacleCheck = getObstacles(s, prevState);
            ks.sensorReadings = srs.getSensorReadings((int) s.sx, (int) s.sy, s.sa, obstacles);
//            ks.underSensors = srs.getLineReading((int) s.sx, (int) s.sy, s.sa, linePoints);
//            ks.collision = checkCollisionOnPath(prevState, command, msp, obstacles, ks.sensorReadings) || checkForCollision(s, obstacles, ks.sensorReadings);
    ...
    {
        return srs.getSensorReadings((int) startState.sx, (int) startState.sy, startState.sa, obstacles);
    }
...
//    public ArrayList<Code.Point> getObstacles(Code.State curS, Code.State prevS)
//    {
//        ArrayList<Code.Point> newObstacles = new ArrayList<Code.Point>();
//
...
//                    {
//                        if(obstacleQuad[x][y]!=null)
//                            newObstacles.addAll((ArrayList<Code.Point>)obstacleQuad[x][y]);
//                    }
//                }
//            }
//        }
